...
var _sigfoxReactRouterLibRouterUtils = require("@sigfox/react-router/lib/RouterUtils");
...
function withStore(ClassComponent) {
  return function WrappedComponent(props) {
    var store = _reactRedux.useStore();
    return _react2["default"].createElement(ClassComponent, _extends({}, props, { store: store }));
  };
}
...
var ReduxRouter = (function (_Component) {
  ...
  function ReduxRouter(props, context) {
    ...
    this.router = _sigfoxReactRouterLibRouterUtils.createRouterObject(this.props.store.history, this.props.store.transitionManager);
  }

  ReduxRouter.prototype.UNSAFE_componentWillMount = function UNSAFE_componentWillMount() {
    this.props.store.dispatch(_actionCreators.initRoutes(getRoutesFromProps(this.props)));
  };

  ReduxRouter.prototype.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(nextProps) {
  ...
  ReduxRouter.prototype.receiveRoutes = function receiveRoutes(routes) {
    ...
    this.props.store.dispatch(_actionCreators.replaceRoutes(routes));
  };
  ...
  ReduxRouter.prototype.render = function render() {
    ...
    var history = _props$store.history;
    var routerStateSelector = _props$store[_constants.ROUTER_STATE_SELECTOR];
...
var ReduxRouterContext = (function (_Component2) {
  ...
  ReduxRouterContext.prototype.render = function render() {
    ...
    var RoutingContext = this.props.RoutingContext || _sigfoxReactRouter.RouterContext;
...
exports["default"] = withStore(ReduxRouter);
